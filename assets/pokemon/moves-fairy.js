...
Array.prototype.push.apply(MoveList, [
	...
	},
	{
		...
		"desc": "寶可夢創造出一面魔法盾來保護所有人免受敵人的陰謀詭计。在這面盾牌後，所有人都能看穿謊言和邪惡的意圖。"
	},
	{
	...
	},
	{
		...
		"accuracy": "洞察 + 表演",
		"damage": "特殊 + 2",
		"effect": "聲音類招式。必中。以所有範圍內的敵人为目標。",
		"desc": "使用者透過魅惑而動人的哭聲，對牠的對手造成情感上的傷害。這个招式總能讓目標感到難受。"
	},
	{
		...
		"desc": "使用者送出一个挑逗般的吻，敵人接住了這个飛吻卻因此被吸取了能量。"
	},
	{
	...
	},
	{
		...
		"accuracy": "洞察 + 自然",
		"damage": "-",
		"effect": "基礎治癒。若場地處於青草場地狀態，則這个招式變为 強效治癒。",
		"desc": "使用者做出一个能治癒佩戴者並使其感到放鬆的花環。在適當的條件下，這个招式還會創造出一个環繞著目標的花圃。"
	},
	{
		...
		"desc": "寶可夢使用神秘的力量使每个草屬性寶可夢的身邊開滿鮮花。場地上的鮮花顯得更具活力且美麗。"
	},
	{
		...
		"accuracy": "洞察 + 自然",
		"damage": "-",
		"effect": "蓄力招式。使用者在蓄力後，接著在牠的下个回合使自己的靈巧、特殊、和特防各提升 2 點。",
	...
	},
	{
		...
		"accuracy": "洞察 + 自然",
		"damage": "-",
		"effect": "基礎治癒。若成功，則消耗 1 點意志點以使其生效。如果在夜晚、或當前天氣狀態为大晴天，則這个招式變为 強效治癒。如果當前天氣狀態为下雨或沙暴，則這个招式只會回復 1 點HP。",
	...
	},
	{
		...
		"accuracy": "洞察 + 自然",
		"damage": "不定",
		"effect": "這个招式的傷害骰池等同於敵人剩餘HP的一半（最多10，向下取整）。如果敵人的剩餘HP只剩下 1 點，則這个招式自動失敗。這个招式無視敵人的防禦和特防。",
	...
	},
	{
		...
		"accuracy": "靈巧 + 導引",
		"damage": "特殊 + 3",
		"effect": "若成功，治療使用者和所有隊友的所有異常狀態。如果這个招式的使用者處於最終進化階段，則這个招式自動失敗。",
	...
	},
	{
		...
		"desc": "使用者釋放出一種令人迷醉的芳香蒸汽，可不要上當，因为它不僅有毒，還有可怕的副作用。"
	},
	{
		...
		"damage": "-",
		"effect": "使敵人陷入「混亂」狀態。",
		"desc": "寶可夢走向敵人並在對方臉上留下一个甜美的吻，接著調皮地離開。敵人將困惑茫然於其中的含義。"
	}
]);