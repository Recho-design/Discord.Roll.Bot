...
Array.prototype.push.apply(AbilityList, [
	...
	},
	{
		...
		"tags": ["nftext|l|因为物理攻擊而瀕死時", "target|l|foe", "frame|target|傷害|number|2"],
		"effect": "如果這隻寶可夢因为非遠程的物理攻擊而陷入瀕死狀態，則該攻擊的使用者將會受到 2 點傷害。",
	...
	},
	{
		...
		"desc": "這隻寶可夢的周遭地面變得相當鬆軟且難以行走。當遭遇危險時，牠會使周遭的地面下沉，創造出一个流沙坑。"
	},
	{
	...
	},
	{
		...
		"effect": "反转「暗黑氣場」和「妖精氣場」特性對牠們使用者的效果。如果該特性會增加牠們使用者的傷害骰池，那麼它將改为減少骰池。",
	...
	},
	{
		...
		"effect": "在每个戰鬥輪結束時，對戰場上任何處於「睡眠」狀態的對象造成 1 點傷害。",
		"desc": "這隻寶可夢能夠透過夢境世界傳送牠邪惡的意圖，造成破壞，並將恐懼帶到那些陷入沉睡的人們心中。"
	},
	{
		"name": "撿球", "alias": "たまひろい|Ball Fetch",
		"tags": ["target|l|self"],
		"effect": "每當你向野生寶可夢丟出精靈球，如果收服判定失敗，則該精靈球不會壞掉，而是改为讓這隻寶可夢在該場景結束時把它帶回給你。",
		"desc": "這隻寶可夢有些沉迷於「丟接球」的遊戲中，牠可以玩上好幾个小時，樂此不疲。"
	},
	{
	...
	},
	{
		...
		"effect": "如果敵人對這隻寶可夢造成了擊中要害，則牠不會因为擊中要害而獲得任何額外的獎勵骰。",
		"desc": "這隻寶可夢的表面被被堅韌材質構成的盔甲給包覆，像是岩石、鋼鐵、或外骨骼。"
	},
	{
		"name": "牽絆變身", "alias": "きずなへんげ|Battle Bond",
		"tags": ["target|l|self"],
		"effect": "在敵人被這隻寶可夢給擊敗<b>之後</b>，如果牠的忠誠度为 5 點，則牠會變化为「戰鬥牽絆型態」持續直到該場景結束，或直到牠或牠的訓練家陷入拚死狀態。每个隊伍只能有一个擁有這个特性的寶可夢。擁有這个特性的寶可夢不能持有超級石。<br><b>戰鬥牽絆型態：</b><ul><li>寶可夢的力量和特殊的上限增加 2 點。</li><li>依照你的判斷为戰鬥牽絆型態重新分配階級給予的特質點数。</li><li>你所選擇的一个招式的威力增加 1 點。</li><li>讓，並解除所有異常狀態。</li><li>當處於戰鬥牽絆型態時，所有該寶可夢受到的戰鬥傷害也都會傷害到牠的訓練家。</li></ul>",
		"desc": "這隻寶可夢與那跟牠一起經歷過最激烈戰鬥的夥伴建立了緊密的聯繫。在贏得勝利之後，因为他們之間的友誼，一股強大的力量湧現了。"
	},
	{
		"name": "異獸提升", "alias": "ビーストブースト|Beast Boost",
		"tags": ["target|l|self", "nftext|l|讓敵人陷入瀕死狀態後", "frame|self|特質|up|1"],
		"effect": "如果敵人因为這隻異獸的攻擊而陷入瀕死狀態，將這隻異獸上限最高的特質提升 1 點。你最多可以透過這个方式提升 3 點。只有異獸能夠擁有這个特性。異獸提升特性無法被交換或複製。",
		"desc": "一種可怕的滿足感會在這隻生物造成破壞時湧現，讓牠隨著每一个倒下的敵人而變得越來越野蠻。"
	},
	{
		...
		"desc": "這隻寶可夢的行为舉止通常相當冷靜，但當牠的性命或牠在乎的對象陷入危險，腎上腺素的衝擊將把牠變成一頭狂怒的野獸。"
	},
	{
	...
	},
	{
		...
		"effect": "當這隻寶可夢的HP剩一半或以下，牠火屬性招式的傷害骰池並不會因为疼痛懲罰而被扣除成功骰，且牠火屬性招式的傷害骰池會額外增加 1 顆骰子。",
	...
	},
	{
		...
		"desc": "這隻寶可夢極度注意牠身邊的整个環境，想要偷偷接近牠將會變得極度困難。"
	},
	{
	...
	},
	{
		...
		"effect": "當這隻寶可夢受到傷害時，牠將暫時把自己的屬性改變成與剛剛命中自己招式相同的屬性。這个效果會在寶可夢退出戰場時結束。",
	...
	},
	{
		...
		"tags": ["target|l|self", "nftext|l|两者互換", "frame|self|特質|down|x", "frame|self|特質|up|x"],
		"effect": "如果有任何效果會降低這隻寶可夢的特質，改为將其提升；如果有任何效果會提升這隻寶可夢的特質，改为將其降低。",
		"desc": "在大部分情況下，這隻寶可夢會想要去做那些與你所想相反的事情。有時牠甚至會因此做出自相矛盾的行为。"
	},
	{
	...
	},
	{
		...
		"effect": "每當這隻寶可夢因某个招式而受到傷害，骰 3 顆機率骰以使對方陷入「定身法」狀態。這个方式可以禁用一个以上的招式。",
	...
	},
	{
		...
		"desc": "也許是因为牠動人的雙眸、或是牠紅潤的臉頰，但無論如何，其他人和寶可夢都會为了贏得這隻寶可夢的芳心而努力。"
	},
	{
	...
	},
	{
		...
		"tags": ["target|l|self"],
		"effect": "每當其他寶可夢使用了名字帶有「舞」關鍵字的招式（例如〈龍之舞〉、〈花瓣舞〉）時，這隻寶可夢能夠馬上緊接著以一个自由動作使用相同的招式，並自動成功（仍必須擲傷害骰）。",
	...
	},
	{
		...
		"effect": "場上所有寶可夢的惡屬性招式的傷害骰池全都額外增加 2 顆骰子。這个效果不會疊加。場上的寶可夢和訓練家將不會彼此合作。",
	...
	},
	{
		...
		"effect": "當這隻寶可夢的HP降到一半或以下時，为這隻寶可夢的每个行動进行忠誠度的判定。若判定失敗，則這隻寶可夢在該行動的力量和特殊特質將被視作降低 2 點。若判定成功，則牠的特質保持不變。",
		"desc": "這隻寶可夢是个天生的悲觀主義者。當情況變得艱難，牠將會第一个放棄。"
	},
	{
	...
	},
	{
		...
		"effect": "當這隻寶可夢出場時，天氣狀態將會自動變为亂流。這个效果將會在這隻寶可夢退場時結束。（若效果互相衝突，則由意志較高的寶可夢影響天氣狀態。）",
		"desc": "整个戰場颳起強風亂流，不知道如何飛行的寶可夢可能會被遠遠吹飛出去。"
	},
	{
		"name": "終結之地", "alias": "おわりのだいち|Desolate Land",
		"tags": ["target|l|field", "weather|l|sun2"],
		"effect": "當這隻寶可夢出場時，天氣狀態將會自動變为大日照。這个效果將會在這隻寶可夢退場時結束。（若效果互相衝突，則由意志較高的寶可夢影響天氣狀態。）",
	...
	},
	{
		...
		"effect": "這隻寶可夢在戰鬥中第一次要受到傷害時，將該傷害降低到零。入場危害、天氣狀態、和異常狀態並不會觸發這个特性。",
	...
	},
	{
		...
		"desc": "這隻寶可夢能夠掃描敵人，連上電腦中的数據並將其下載到牠自己體內。太過大量的資料可能會讓牠感到有些沉重。"
	},
	{
		"name": "降雨", "alias": "あめふらし|Drizzle",
		"tags": ["target|l|field", "weather|l|rain"],
		"effect": "當這隻寶可夢出場時，天氣狀態將會自動變为下雨。這个效果將會在這隻寶可夢退場時結束。（若效果互相衝突，則由意志較高的寶可夢影響天氣狀態。）",
		"desc": "只要這隻寶可夢這麼希望，天空就會在彷彿永不停息的風暴中持續不斷降雨。"
	},
	{
		"name": "日照", "alias": "ひでり|Drought",
		"tags": ["target|l|field", "weather|l|sun"],
		"effect": "當這隻寶可夢出場時，天氣狀態將會自動變为大晴天。這个效果將會在這隻寶可夢退場時結束。（若效果互相衝突，則由意志較高的寶可夢影響天氣狀態。）",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为大晴天，則這隻寶可夢將在每个戰鬥輪結束時受到 1 點傷害。火屬性招式對這隻寶可夢將造成額外 1 點傷害。水屬性招式可能會使這隻寶可夢回復 1 點HP，而非造成傷害。",
		"desc": "這隻寶可夢的肌膚需要特別的照料，它需要持續保濕並防範高溫。"
	},
	{
		"name": "早起", "alias": "はやおき|Early Bird",
		"tags": ["target|l|self", "frame|sleep||number|½"],
		"effect": "這隻寶可夢處於「睡眠」狀態的時間減少一半，牠只需要在洞察掷骰判定中累積獲得 2 顆或以上的成功骰就能在戰鬥中從「睡眠」狀態下清醒過來。這个效果並不適用於招式〈睡覺〉造成的「睡眠」狀態。",
		"desc": "擁有這个特性的寶可夢是个很容易從沉睡中清醒的淺眠者。牠們只需要数个小時的睡眠時間就能充滿精神的醒過來。"
	},
	{
		"name": "孢子", "alias": "ほうし|Effect Spore",
		"tags": ["target|l|foe", "nftext|l|當被物理攻擊命中時，随机造成", "frame|poison||number|d3", "frame|paralysis||number|d3", "frame|sleep||number|d3"],
		"effect": "當被非遠程攻擊的物理攻擊給命中時，這隻寶可夢將骰 3 顆機率骰以随机使敵人陷入「中毒」、「麻痺」、或「睡眠」狀態。",
	...
	},
	{
		...
		"desc": "這隻寶可夢能夠創造出環繞自己的電氣場地，使空氣充滿緊繃的氛圍，也讓每个人都感到緊張不安。"
	},
	{
		"name": "危險迴避", "alias": "ききかいひ|Emergency Exit",
		"tags": ["target|l|self", "nftext|l|HP降到一半或以下時", "effect|l|switcher", "target|l|ally"],
		"effect": "每當這隻寶可夢的HP降到一半或以下時，牠將會回到自己的精靈球，並換上一名隊友來代替牠。如果沒有其他隊友，則戰鬥直接結束。這个特性的效果不會被「阻擋」給影響。",
		"desc": "這隻寶可夢會在情勢升級失控時採取戰術性撤退，儘管你可以強迫牠进行戰鬥，但牠可不會喜歡這麼做。"
	},
	{
		"name": "妖精氣場", "alias": "フェアリーオーラ|Fairy Aura",
		"tags": ["target|l|field", "text|l|妖精招式|Fairy", "frame|self|傷害|plus|d2"],
		"effect": "場上所有寶可夢的妖精屬性招式的傷害骰池全都額外增加 2 顆骰子。這个效果不會疊加。場上的寶可夢和訓練家將不會攻擊這个特性的使用者。",
	...
	},
	{
		...
		"desc": "擁有這个特性的寶可夢能從火焰產生的極端高熱中受益，這可能會讓牠有點像是縱火狂。"
	},
	{
	...
	},
	{
		...
		"effect": "這隻寶可夢的屬性會根據當前的天氣狀態而改變：大晴天時變为火屬性、下雨時變为水屬性、冰雹時變为冰屬性、沙暴時變为岩石屬性。",
	...
	},
	{
		...
		"effect": "在戰鬥中，這隻寶可夢會警告牠的訓練家關於其中一个敵人所擁有的最強招式的情報。說書人必須秘密地將情報告知這隻寶可夢的訓練家。",
		"desc": "當這隻寶可夢感覺到惡意或災難的接近，牠將會透過心靈感應警告牠的訓練家。訓練家必須使用洞察进行判定來接收這个訊息。"
	},
	{
		...
		"desc": "這隻寶可夢相當可愛，並能喚醒他人心中的母性。牠的每个同伴都會試圖保護好牠。"
	},
	{
		"name": "察覺", "alias": "おみとおし|Frisk",
		"tags": ["target|l|rfoe", "nftext|l|揭露持有的物品"],
		"effect": "當這隻寶可夢進入戰場時，說書人必須把牠其中一个敵人持有的物品告訴這隻寶可夢的訓練家。",
	...
	},
	{
		...
		"desc": "這隻寶可夢毛絨絨的外在相當柔軟、可愛想抱、且不會讓人過敏，它同時還能做为抵禦強大打擊的緩衝。"
	},
	{
		...
		"desc": "這隻寶可夢的羽翼構造經過完美設计，讓牠能輕鬆駕馭最惡劣的狂風。"
	},
	{
	...
	},
	{
		...
		"tags": ["target|l|self"],
		"effect": "這隻寶可夢可以食用任何類型的食物、藥物、或草藥，而不會承受任何負面效果。這隻寶可夢可以在戰鬥中的任何時候以一个自由動作吃掉牠所持有的樹果。",
		"desc": "這隻寶可夢可以吃上一整天，牠完全不用擔心找不到食物來源，因为牠超級不挑食。"
	},
	{
	...
	},
	{
		...
		"tags": ["target|l|self", "frame|self|力量|up|1", "nftext|l|只能进行閃避和使用一个招式"],
		"effect": "在戰鬥開始時，選擇一个招式。這隻寶可夢的力量特質提升 1 點，且牠每个戰鬥輪都只能使用所選擇的招式或进行閃避。這个效果會在這隻寶可夢被從戰鬥中收回時重置。",
	...
	},
	{
		...
		"effect": "如果這隻寶可夢使用了招式〈衝浪〉或〈潛水〉，則牠會在造成傷害後改變型態。如果牠的HP還剩下超過一半，則變为「一口吞型態」；如果牠的HP還剩下一半或以下，則變为「大口吞型態」。當這隻寶可夢在處於其中任意一个型態期間受到敵人造成的傷害，牠將骰 2 顆傷害骰以對敵人造成傷害，並根據型態造成額外效果（「一口吞型態」將使敵人的防禦降低 1 點；「大口吞型態」將使敵人陷入「麻痺」狀態），在這之後，這隻寶可夢將會恢復原本的型態。",
		"desc": "這隻寶可夢是个出色的獵手，牠總是能在潛入水池後帶著獵物飛翔而出，且牠有時候會把獵物當作武器使用……"
	},
	{
		"name": "毅力", "alias": "こんじょう|Guts",
		"tags": ["target|l|self", "nftext|l|處於異常狀態時", "frame|self|力量|up|2"],
		"effect": "當處於異常狀態時，這隻寶可夢的力量特質提升 2 點。",
		"desc": "這隻寶可夢敢於做出所有他人不敢为之的行動，且不會輕易失去牠的決心，儘管這可能會讓牠顯得有些魯莽。"
	},
	{
	...
	},
	{
		...
		"effect": "如果戰場上的某个隊友處於異常狀態，則在該戰鬥輪結束時，這隻寶可夢可以骰 3 顆機率骰以治療該狀態。",
	...
	},
	{
		...
		"tags": ["target|l|self", "nftext|l|體重變为两倍"],
		"effect": "這隻寶可夢的重量變为原本的两倍。基於寶可夢體重的招式的傷害將根據這个變化產生相應的調整。",
		"desc": "包裹著這隻寶可夢身體的金屬是如此厚重，以至於它能輕易使這隻寶可夢的重量變为原本的两倍。"
	},
	{
	...
	},
	{
		...
		"tags": ["target|l|self", "text|l|型態變化"],
		"effect": "只有莫魯貝可能夠使用這个特性。這个特性無法被複製或交換。在戰鬥輪結束時，切換這隻寶可夢的型態（「滿腹型態」／「空腹型態」）。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为冰雹，則這隻寶可夢可以在戰鬥輪結束時回復 1 點HP。這隻寶可夢免疫冰雹天氣造成的傷害。",
		"desc": "這隻寶可夢的身體彷彿結凍，零度以下的溫度對牠來說就像是老家一樣。"
	},
	{
		"name": "結凍頭", "alias": "アイスフェイス|Ice Face",
		"tags": ["target|l|self", "weather|l|hail", "text|l|型態變化"],
		"effect": "當這隻寶可夢處於「結凍頭型態」時，這隻寶可夢擁有 2 點額外HP。如果結凍頭受到 2 點傷害，則這隻寶可夢將變为「解凍頭型態」。要重新變回「結凍頭型態」，這隻寶可夢必須在冰雹天氣狀態中待上一整輪的時間。",
	...
	},
	{
		...
		"desc": "這隻寶可夢的身軀被冰晶鱗片給覆蓋。總是散發著寒氣，牠能夠輕易用體表偏折掉大多数的投射物、能量、光線。"
	},
	{
	...
	},
	{
		...
		"effect": "當這隻寶可夢出場時，牠會以隊伍中的另一隻寶可夢的外型登場；牠會在受到傷害時變回牠原本的外型。當牠變为人類的外觀時，牠不會說話，且牠的尾巴仍可能會露出來。",
	...
	},
	{
		...
		"desc": "這隻寶可夢能夠以極快的速度改變牠自己的細胞結構，變身成另一个生物的複製體。"
	},
	{
	...
	},
	{
		...
		"effect": "如果某个攻擊將使這隻寶可夢陷入瀕死狀態，則牠會對敵人造成等同於自己剩餘HP的傷害。",
	...
	},
	{
		...
		"effect": "當這隻寶可夢出場時，使範圍內所有敵人的力量降低 1 點。只要這隻寶可夢在場上，這个效果就會持續。降低遭遇野生寶可夢的機率。",
	...
	},
	{
		...
		"effect": "當這隻寶可夢第一次被惡屬性攻擊命中、或當牠目睹了某个牠認为不公義的事件時，這隻寶可夢的力量特質提升 1 點。",
		"desc": "這隻寶可夢有著天生的正義感，惡行將會使牠感到非常憤怒。"
	},
	{
		"name": "銳利目光", "alias": "するどいめ|Keen Eye",
		"tags": ["target|l|self", "frame|self|命中|down|never"],
		"effect": "這隻寶可夢的命中判定的成功骰不會因为招式、道具、或特性的影響而被扣除。但疼痛懲罰和難度懲罰仍會適用。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为大晴天，則這隻寶可夢不會陷入任何異常狀態。在這之前陷入的異常狀態仍會保留。",
		"desc": "這隻寶可夢身上的葉片隨著陽光延展以遮蓋自己的身體。"
	},
	{
		"name": "飄浮", "alias": "ふゆう|Levitate",
		"tags": ["target|l|self", "nftext|l|免疫", "text|l|地面招式|Ground"],
		"effect": "地面屬性的招式和地面上的效果都不會影響這隻寶可夢。如果這隻寶可夢使用了會把牠自己束縛在地面上的招式，則這个效果將會消失，直到牠再次脫離地表。",
		"desc": "這隻寶可夢飄浮在空中四處移動而無須接觸地表。"
	},
	{
		"name": "自由者", "alias": "リベロ|Libero",
		"tags": ["target|l|self", "text|l|改變屬性"],
		"effect": "每當這隻寶可夢使用了一个招式，把牠的屬性先改變为該招式的屬性。若該招式为攻擊招式且會造成傷害，則適用屬性一致加成。",
		"desc": "這隻寶可夢在比賽中總有自己的计畫。牠喜歡居於守勢，並在最後進攻時做出最棒的特殊傳球。"
	},
	{
		"name": "輕金屬", "alias": "ライトメタル|Light Metal",
		"tags": ["target|l|self", "nftext|l|體重變輕"],
		"effect": "這隻寶可夢的重量變为原本的50%~75%。基於寶可夢體重的招式的傷害將根據這个變化產生相應的調整。",
		"desc": "包裹著這隻寶可夢身體的金屬彷彿羽毛一樣輕盈，使這隻寶可夢的體重變为原本的 50% 到 75%。"
	},
	{
		"name": "避雷針", "alias": "ひらいしん|Lightning Rod",
		"tags": ["target|l|self", "nftext|l|吸引並免疫", "text|l|電系招式|Electric", "frame|self|傷害|plus|d1"],
		"effect": "如果有任何人使用了單一目標的電屬性招式，則該招式的目標將會引導變更为這隻寶可夢；這隻寶可夢免疫任何電屬性招式的傷害。當這隻寶可夢第一次被電屬性招式命中，這隻寶可夢的特殊特質提升 1 點。",
	...
	},
	{
		...
		"tags": ["target|l|foe"],
		"effect": "如果這隻寶可夢被會吸收牠生命能量的招式給命中（比如說〈寄生種子〉、〈食夢〉、〈吸收拳〉等），則該招式會改为對使用者造成等量的傷害。",
	...
	},
	{
		...
		"effect": "這隻寶可夢使用的所有聲音類招式都將被視为水屬性。",
	...
	},
	{
		...
		"effect": "這隻寶可夢使用的每个名字帶有「波動」或「波導」關鍵字的招式，其傷害骰池／治療骰池都將額外增加 2 顆骰子。",
	...
	},
	{
		...
		"effect": "如果敵人處於「中毒」或「劇毒」狀態，則這隻寶可夢對牠使用的所有招式都將視为擊中要害。根據說書人的判斷，這隻寶可夢在使用會造成致命傷害的招式時將不會「手下留情」。",
	...
	},
	{
		...
		"effect": "如果有任何場地招式正在生效（像是〈電氣場地〉、〈精神場地〉等），則這隻寶可夢的主要屬性將會變为與該場地相符的屬性。如果該場地效果結束，則牠的主要屬性也會變回原樣。",
		"desc": "這隻寶可夢的身體能夠完美地偽裝融入地面，有時會很容易把牠搞丟，但你總是能在某个不幸的受害者踩到牠時找到牠。"
	},
	{
		"name": "負電", "alias": "マイナス|Minus",
		"tags": ["target|l|self", "nftext|l|若有「正電」特性的隊友", "frame|self|特殊|up|2"],
		"effect": "如果戰場上有寶可夢隊友的特性为「正電」，則這隻寶可夢的特殊特質提升 2 點。",
	...
	},
	{
		...
		"effect": "所有以這隻寶可夢或牠那一方的戰場为目標，會降低特質的效果都將被反彈，改为以敵人为目標。",
	...
	},
	{
		...
		"effect": "如果敵人擁有任何屬性、特性、或其他免疫能力能阻止這隻寶可夢使用某个招式對其进行攻擊，將其忽略。",
		"desc": "這隻寶可夢將找出不尋常的手段來達成牠的目的。牠們善於創新，繞過難題。"
	},
	{
		"name": "心情不定", "alias": "ムラっけ|Moody",
		"tags": ["target|l|self", "nftext|l|随机", "frame|self|特質|up|1", "frame|self|特質|down|1"],
		"effect": "在每个戰鬥輪結束時，重置「心情不定」造成的特質調整，接著讓一个随机特質降低 1 點，並讓另一个随机特質提升 1 點。",
		"desc": "這隻寶可夢的情緒起伏劇烈，且大多数時候都喜怒無常。但願這只是暫時性的問題。"
	},
	{
	...
	},
	{
		...
		"effect": "如果敵人因为這隻寶可夢的攻擊而陷入瀕死狀態，則這隻寶可夢的力量提升 1 點。你最多可以透過這个方式提升 3 點。",
	...
	},
	{
		...
		"effect": "如果這隻寶可夢的HP全滿，則這隻寶可夢因为被攻擊而受到的傷害將減少 1 點。",
		"desc": "這隻寶可夢被两層堅硬的鱗片給覆蓋，如果其中一層鱗片破損，則它們會脫落並在稍後重新長回來。"
	},
	{
		"name": "多屬性", "alias": "マルチタイプ|Multitype",
		"tags": ["target|l|self", "text|l|改變屬性"],
		"effect": "這隻寶可夢能夠在任何時候自由的改變自己的屬性。這个特性無法被任何手段給複製、交換、改變、忽略、或無效。",
		"desc": "創造出這个宇宙的所有能量都在這隻寶可夢的體內流竄，且牠能夠駕馭最符合當前所需的能量類型。"
	},
	{
		"name": "木乃伊", "alias": "ミイラ|Mummy",
		"tags": ["target|l|foe", "nftext|l|當用物理攻擊命中這隻寶可夢時", "text|l|改變特性"],
		"effect": "當這隻寶可夢被非遠程物理攻擊命中、或使用非遠程物理攻擊命中敵人時，將敵人的特性變为「木乃伊」。",
		"desc": "這隻寶可夢會詛咒任何膽敢對牠造成傷害的事物，這个詛咒甚至可能會持續好幾个世代，且會需要靈媒的協助才能將其解除。"
	},
	{
		"name": "自然回復", "alias": "しぜんかいふく|Natural Cure",
		"tags": ["target|l|self", "frame|heal|治療狀態|number|d3"],
		"effect": "在每个戰鬥輪結束時，如果這隻寶可夢處於任何異常狀態，則骰 3 顆機率骰以治療自己。",
		"desc": "這隻寶可夢的身體能夠製造物質來治療自己。牠們的這个特性也能被用來生產藥物。"
	},
	{
	...
	},
	{
		...
		"effect": "你可以在戰鬥輪開始時宣告自己不會进行任何閃避動作。如果你這麼做，則這隻寶可夢在为牠的所有招式进行命中判定時將視作沒有任何「降低命中率」標誌。",
	...
	},
	{
		...
		"effect": "這隻寶可夢的所有招式都被視为一般屬性，並適用屬性一致加成、弱點和抗性。一般屬性招式的傷害骰池額外增加 1 顆骰子。",
	...
	},
	{
		...
		"effect": "當這隻寶可夢的HP剩一半或以下，牠草屬性招式的傷害骰池並不會因为疼痛懲罰而被扣除成功骰，且牠草屬性招式的傷害骰池會額外增加 1 顆骰子。",
		"desc": "當這隻寶可夢受傷時，牠的體內會長出巨大的植物來保衛自己；這个植物相當強勁但凋萎很快。"
	},
	{
		"name": "我行我素", "alias": "マイペース|Own Tempo",
		"tags": ["target|l|self", "frame|confuse||never"],
		"effect": "這隻寶可夢不會陷入「混亂」狀態。",
		"desc": "這隻寶可夢以自己的步調做事，忽略所有同儕壓力。牠的行为舉止出於本能，且相當冷靜……或許有點太冷靜了。"
	},
	{
		"name": "親子愛", "alias": "おやこあい|Parental Bond",
		"tags": ["target|l|self", "nftext|l|骰二次傷害骰並取高"],
		"effect": "這隻寶可夢的所有傷害骰池都可以骰二次。選擇較好的掷骰結果以對敵人造成傷害。",
	...
	},
	{
		...
		"effect": "如果這隻寶可夢被非遠程物理攻擊給命中，則除非敵人脫離戰鬥，否則敵人將會在三个戰鬥輪之後受到等同於牠剩餘HP的傷害並陷入瀕死狀態。",
		"desc": "這隻寶可夢會無聲地詛咒任何膽敢冒犯牠的對象，讓他們的靈魂承受牠所遭受的痛苦。試著避開這隻寶可夢，以免你承受牠降下的怨恨。"
	},
	{
		"name": "撿拾", "alias": "ものひろい|Pick up",
		"tags": ["target|l|self"],
		"effect": "如果這隻寶可夢待在精靈球外面，則在該場景結束時，看看牠为你找到了什麼東西（由說書人決定）。",
		"desc": "這隻寶可夢會經常收集東西，並堆成一个可能會與你分享的小寶物堆。"
	},
	{
	...
	},
	{
		...
		"desc": "這隻寶可夢散撒著能为心靈帶來快樂想法的妖精塵。牠所做的一切行为看起來都非常可愛。"
	},
	{
		"name": "正電", "alias": "プラス|Plus",
		"tags": ["target|l|self", "nftext|l|若有「負電」特性的隊友", "frame|self|特殊|up|2"],
		"effect": "如果戰場上有寶可夢隊友的特性为「負電」，則這隻寶可夢的特殊特質提升 2 點。",
	...
	},
	{
		...
		"effect": "如果這隻寶可夢處於「中毒」或「劇毒」狀態，則牠會在每个戰鬥輪結束時回復 1 點HP，而非受到傷害。這些毒素會在三个戰鬥輪之後被完全吸收。",
	...
	},
	{
		...
		"tags": ["target|l|self", "text|l|型態變化"],
		"effect": "在戰鬥輪結束時，如果這隻寶可夢的HP低於或等於一半，則牠將會變化成下一个階段的型態。當這隻寶可夢的型態發生改變，牠將解除任何異常狀態，且將HP和意志點回復至全滿。這个特性無法被複製、交換、或改變。<ul><li>基格爾德(核心) → 基格爾德(10%)</li><li>基格爾德(10%) → 基格爾德(50%)</li><li>基格爾德(50%) → 基格爾德(100%)</li></ul>",
	...
	},
	{
		...
		"effect": "這隻寶可夢將會複製一个陷入瀕死狀態的敵人寶可夢的特性，持續24小時。這个方式能夠同時複製多个特性，但在戰鬥期間只能有一个特性可以發揮作用。（在說書人的判斷下，某些特性可能會無法被複製。）",
	...
	},
	{
		...
		"effect": "其中一个隊友的招式的傷害骰池將額外增加 1 顆骰子。如果有複数个寶可夢使用這个特性，這个效果也不會疊加在同一个隊友身上。",
	...
	},
	{
		...
		"desc": "這隻寶可夢的尾鰭能夠讓牠在水中非常輕易地四處移動。牠能夠毫無困難地做出急转彎來追趕或抓捕牠的獵物。"
	},
	{
	...
	},
	{
		...
		"effect": "當這隻寶可夢陷入任何異常狀態時，牠的靈巧特質提升 2 點。這隻寶可夢仍會陷入「麻痺」狀態，但這个特性將避免其效果發揮作用。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为下雨，則這隻寶可夢可以在每輪結束時回復 1 點HP。",
	...
	},
	{
		...
		"effect": "如果一个隊友在戰鬥中陷入瀕死狀態，這隻寶可夢能夠複製牠的特性並持續24小時。這个方式同時只能複製一个特性。（在說書人的判斷下，某些特性可能會無法被複製。）",
		"desc": "這隻寶可夢向來擅於學習其他與牠之間有著羈絆的寶可夢的戰術行为。"
	},
	{
		...
		"desc": "为了得到牠想要的事物，這隻寶可夢經常攪入危險的情境。牠們很容易不考慮後果就冒著生命危險。"
	},
	{
	...
	},
	{
		...
		"effect": "這隻寶可夢每天都可以自行回復最多 4 點傷害或最多 2 點致命傷害。這隻寶可夢必須脫離戰鬥才能得到這个效果的好處。",
		"desc": "這隻寶可夢的身體能夠以非常快的速度自我再生，需要好幾天才能恢復的傷勢只需要幾个小時就能明顯好转。"
	},
	{
	...
	},
	{
		...
		"effect": "如果這隻寶可夢的敵人为同性，則牠的力量提升 1 點。如果這隻寶可夢的敵人为異性，則牠的力量降低 1 點。",
		"desc": "为了證明自己是群體中的老大，這隻寶可夢會與其他同性进行相當激烈的競爭。然而，牠會試圖贏得每一个配偶候選人的青睞。"
	},
	{
		"name": "ＡＲ系統", "alias": "ＡＲシステム|RKS System",
		"tags": ["target|l|self", "text|l|改變屬性"],
		"effect": "這隻寶可夢的屬性會變更为與其持有的記憶碟相符的屬性。（例如：「電子記憶碟」會使這隻寶可夢變为電屬性。）",
		"desc": "這隻寶可夢的生理型態會根據插入牠ＡＲ系統的記憶碟而產生變化。記憶碟一共有17種，每个屬性各一種。（沒有一般屬性的記憶碟。）"
	},
	{
	...
	},
	{
		...
		"desc": "在觸碰這隻寶可夢時請務必保護好你的雙手，因为牠的身體覆蓋著能夠割傷肌膚的鋒利鱗片或棘刺。"
	},
	{
		"name": "逃跑", "alias": "にげあし|Run Away",
		"tags": ["target|l|self", "nftext|l|免疫於", "effect|l|block"],
		"effect": "這隻寶可夢不會被阻擋。根據說書人的判斷，牠在为從戰鬥中逃跑或逃離囚禁時进行的判定也可能會得到額外的獎勵骰。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为沙暴，則這隻寶可夢地面、岩石、和鋼屬性招式的傷害骰池都會額外增加 1 顆骰子。這隻寶可夢免疫沙暴天氣造成的傷害。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为沙暴，則這隻寶可夢的靈巧特質提升 1 點。這隻寶可夢免疫沙暴天氣造成的傷害。",
		"desc": "當沙塵橫掃這个戰場，這隻寶可夢能夠穿梭其中，如魚得水。"
	},
	{
		"name": "吐沙", "alias": "すなはき|Sand Spit",
		"tags": ["target|l|field", "nftext|l|當被物理攻擊命中時", "weather|l|sand"],
		"effect": "當這隻寶可夢被非遠程攻擊的物理攻擊給命中時，牠將把天氣狀態變为沙暴。這个效果將持續 4 輪。",
		"desc": "這隻寶可夢蜿蜒穿過沙漠中的沙土，並在過程中吃掉一些沙子。如果牠被擊中（或打了个噴嚏），則牠將噴出一股沙塵暴。"
	},
	{
		"name": "揚沙", "alias": "すなおこし|Sand Stream",
		"tags": ["target|l|field", "weather|l|sand"],
		"effect": "當這隻寶可夢出場時，天氣狀態將會自動變为沙暴。這个效果將會在這隻寶可夢退場時結束。（若效果互相衝突，則由意志較高的寶可夢影響天氣狀態。）",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为沙暴，則這隻寶可夢的閃避技能提升 1 點。這隻寶可夢免疫沙暴天氣造成的傷害。",
	...
	},
	{
		...
		"desc": "這隻寶可夢完全以植物为食，牠特別喜歡攝食植物的鮮甜汁液以獲取養分。"
	},
	{
		"name": "魚群", "alias": "ぎょぐん|Schooling",
		"tags": ["target|l|self", "text|l|型態變化"],
		"effect": "只有弱丁魚能夠使用這个特性。當牠的HP剩一半或以下，牠的魚群同伴將會在一段時間後抵達。當牠們抵達後，將弱丁魚的数據取代为滿HP的「弱丁魚（魚群型態）」，並將其階級提升到「專家」。在戰鬥結束後，弱丁魚將變回原本的型態。<br/>．若位於海洋/河流，魚群將在該輪結束時抵達。<br/>．若位於公路/城鎮，魚群將在第二輪結束時抵達。<br/>．若位於洞窟/城市，魚群將在第三輪結束時抵達。<br/>．若位於沙漠/雪地，魚群將在第四輪結束時抵達。<br/>．若位於火山，魚群將在第五輪結束時抵達。<br/>（治療／陷入瀕死／替換寶可夢將會阻礙魚群抵達的時間）",
		"desc": "當這隻寶可夢受到威脅時，牠會喚來数千名同伴以集合成一隻不受控的大怪物。牠越接近海洋，魚群就會越快抵達。"
	},
	{
	...
	},
	{
		...
		"effect": "這隻寶可夢造成的所有效果都將額外增加 2 顆機率骰。（例如：一个會骰 3 顆機率骰以使敵人陷入「畏縮」狀態的招式，將會變成骰 5 顆機率骰。）",
	...
	},
	{
		...
		"effect": "如果這隻寶可夢的HP全滿，則這隻寶可夢因为被攻擊而受到的傷害將減少 2 點。這个特性無法被招式或特性給忽略。",
		"desc": "當在充滿力量的狀態下，這隻寶可夢鬼魅般的身體將不會被任何東西給碰觸或刺穿，牠甚至能夠穿透牆壁，就彷彿牠不存在這个世界上一樣。"
	},
	{
		"name": "踩影", "alias": "かげふみ|Shadow Tag",
		"tags": ["target|l|allfoe", "effect|l|block"],
		"effect": "所有敵人被阻擋。幽靈屬性和相同特性的寶可夢將免疫這个效果。",
		"desc": "這隻寶可夢踩住對手的影子，不讓對方離自己太遠。"
	},
	{
		"name": "蛻皮", "alias": "だっぴ|Shed Skin",
		"tags": ["target|l|self", "frame|heal|治療狀態|number|d3"],
		"effect": "在每个戰鬥輪結束時，如果這隻寶可夢正處於異常狀態，則骰 3 顆機率骰以治療自己的異常狀態。",
	...
	},
	{
		...
		"effect": "每當這隻寶可夢进行一个使用機率骰造成額外效果的攻擊時，你可以忽略這些機率骰，以使該招式的傷害骰池額外增加 2 顆骰子。",
	...
	},
	{
		...
		"tags": ["target|l|self", "text|l|型態變化"],
		"effect": "只有小隕星能夠使用這个特性。當牠的HP剩一半或以下，將小隕星的数據取代为滿HP的「小隕星（核心型態）」。若要恢復其原本的型態，小隕星（核心型態）必須被放生，並在数天後等牠回來後再重新捕捉。",
	...
	},
	{
		...
		"tags": ["target|l|self", "nftext|l|前五輪的先攻順序为最後"],
		"effect": "在戰鬥的前五个戰鬥輪期間，這隻寶可夢的先攻順序永遠會是最後一个。在經過這五个戰鬥輪之後，這隻寶可夢的力量和靈巧特質提升 2 點，且牠的先攻順序改成永遠會是第一个。這个效果會在這隻寶可夢脫離戰鬥時重置。",
		"desc": "這隻寶可夢已經沉睡了数千年，牠的動作緩慢而沉重。最好在牠釋放全力之前逃跑！"
	},
	{
		"name": "撥雪", "alias": "ゆきかき|Slush Rush",
		"tags": ["target|l|self", "weather|l|hail", "frame|self|靈巧|up|1", "nftext|l|免疫冰雹傷害"],
		"effect": "如果當前天氣狀態为冰雹，則這隻寶可夢的靈巧特質提升 1 點。這隻寶可夢免疫冰雹天氣造成的傷害。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为冰雹，則這隻寶可夢的閃避技能提升 1 點。這隻寶可夢免疫冰雹天氣造成的傷害。",
		"desc": "這隻寶可夢的外表能很好地融入冰天雪地之中，你很難辨識出牠的身影。"
	},
	{
		"name": "降雪", "alias": "ゆきふらし|Snow Warning",
		"tags": ["target|l|field", "weather|l|hail"],
		"effect": "當這隻寶可夢出場時，天氣狀態將會自動變为冰雹。這个效果將會在這隻寶可夢退場時結束。（若效果互相衝突，則由意志較高的寶可夢影響天氣狀態。）",
		"desc": "這隻寶可夢能夠憑意志換來可怕的雹暴。白雪將覆蓋整个戰場，尖銳的冰雹塊將從天空傾盆而下。"
	},
	{
		"name": "太陽之力", "alias": "サンパワー|Solar Power",
		"tags": ["target|l|self", "weather|l|sun", "frame|self|傷害|1", "frame|self|特殊|up|2"],
		"effect": "在天氣狀態为大晴天的期間，這隻寶可夢的特殊提升 2 點，但這隻寶可夢也會在每个戰鬥輪結束時受到 1 點傷害。",
	...
	},
	{
		...
		"effect": "如果敵人因为這隻寶可夢的攻擊而陷入瀕死狀態，則這隻寶可夢的特殊提升 1 點。你最多可以透過這个方式提升 3 點。",
		"desc": "這隻寶可夢有著關懷與養育他人的天性，如果牠所愛的人們受到威脅，牠的靈魂將會因为愛而變得更強大。"
	},
	{
	...
	},
	{
		...
		"effect": "在每个戰鬥輪結束時，這隻寶可夢的靈巧特質提升 1 點。你最多可以透過這个方式提升 3 點。",
		"desc": "這隻寶可夢將開始不斷加速的勢頭高速機動，牠將彷彿瞬間移動一般從這个地方移動到另一个地方。"
	},
	{
		"name": "監視", "alias": "はりこみ|Stakeout",
		"tags": ["target|l|foe", "frame|target|傷害|plus|1"],
		"effect": "每當敵方寶可夢被換上場時，這隻寶可夢對牠进行的第一次成功的攻擊將額外造成 1 點傷害。",
		"desc": "這隻寶可夢總是監看著周遭環境，找尋可能的獵物，並在牠們最为脆弱的瞬間發起攻勢。"
	},
	{
		"name": "慢出", "alias": "あとだし|Stall",
		"tags": ["target|l|self", "nftext|l|先攻順序永遠为最後"],
		"effect": "這隻寶可夢的先攻順序永遠为最後一个。",
	...
	},
	{
		...
		"tags": ["target|l|self", "nftext|l|忽略任何會重新引導目標的招式或特性"],
		"effect": "忽略任何會將這隻寶可夢的招式引導到其他目標的招式或特性效果。（像是〈看我嘛〉或「避雷針」特性。）",
		"desc": "這隻寶可夢天生具有高度的責任感和忠誠心，一旦你交付牠某个任務，則直到完成任務之前牠都不會偏離原路。"
	},
	{
	...
	},
	{
		...
		"tags": ["target|l|self", "text|l|型態變化"],
		"effect": "只有堅盾劍怪能夠使用這个特性。在每个戰鬥輪開始時，從「劍型態」和「盾型態」中選擇一个型態。當處於「劍型態」時，牠只能使用攻擊招式；當處於「盾型態」時，牠只能使用變化類招式。根據階級和特質上限調整牠各个形態的特質。",
	...
	},
	{
		...
		"desc": "這隻寶可夢在大部分時候都有著執著倔強的表現。如果牠下定了決心去做某事，那牠就會去做，這个姿態將能激勵鼓舞他人。"
	},
	{
	...
	},
	{
		...
		"effect": "如果有任何人使用了單一目標的水屬性招式，則該招式的目標將會引導變更为這隻寶可夢；這隻寶可夢免疫任何水屬性招式的傷害。當這隻寶可夢第一次被水屬性招式命中，這隻寶可夢的特殊特質提升 1 點。",
	...
	},
	{
		...
		"tags": ["target|l|self"],
		"effect": "當這隻寶可夢第一次因为傷害類招式而將要陷入瀕死狀態時，改为將牠維持在 1 點HP的狀態。異常狀態和自己造成的傷害仍然會導致牠陷入瀕死狀態。這隻寶可夢必須休息至少一个小時才能夠再次使用這个特性的效果。",
	...
	},
	{
		...
		"effect": "這隻寶可夢使用的攻擊招式獲得「高要害率」效果。如果該招式已經擁有「高要害率」效果，則這隻寶可夢只需要比需求成功骰数還要多 1 顆成功骰的掷骰結果（而非原本的 2 顆）就能夠擊中要害。",
	...
	},
	{
		...
		"effect": "當這隻寶可夢的HP剩一半或以下，牠蟲屬性招式的傷害骰池並不會因为疼痛懲罰而被扣除成功骰，且牠蟲屬性招式的傷害骰池會額外增加 1 顆骰子。",
	...
	},
	{
		...
		"effect": "如果當前天氣狀態为下雨，則這隻寶可夢的靈巧特質提升 2 點。",
		"desc": "這隻寶可夢在水中能夠移動的比在陸地上還要快，即使是在道路中的水坑都能讓牠發揮全速。"
	},
	{
		"name": "共生", "alias": "きょうせい|Symbiosis",
		"tags": ["target|l|ally", "nftext|l|把持有物品交給隊友"],
		"effect": "當某个隊友失去或消耗掉自己的持有物品時，這隻寶可夢將立刻以一个自由動作把自己的持有物品交給該隊友。",
		"desc": "這隻寶可夢喜歡與任何跟牠搭檔的隊友共組一个互利的羈絆關係。"
	},
	{
	...
	},
	{
		...
		"effect": "當這隻寶可夢處於「混亂」狀態時，敵人以這隻寶可夢为目標的所有招式都將追加「降低命中率」的標誌。",
		"desc": "這隻寶可夢在暈眩或混亂時會以一種奇怪且特別的方式移動，這通常能反過來成为牠的優勢。"
	},
	{
	...
	},
	{
		...
		"tags": ["target|l|self"],
		"effect": "如果有任何招式、物品、或特性會阻止這隻寶可夢以某个敵人为目標、或造成任何效果，將其忽略。（例如：「免疫」特性的寶可夢仍然會陷入「中毒」狀態、「飄浮」特性仍會被地面屬性招式給命中。）",
	...
	},
	{
		...
		"effect": "如果敵人對這隻寶可夢使用的招式擁有抗性，則改为讓該攻擊如常造成傷害。如果敵人對這隻寶可夢使用的招式擁有雙重抗性，則改为視同對方只擁有一个抗性。",
		"desc": "這隻寶可夢護目鏡般的雙眼能夠在每个惡劣情境中找到好的那一面，就算完全沒有也一樣。"
	},
	{
		"name": "激流", "alias": "げきりゅう|Torrent",
		"tags": ["target|l|self", "nftext|l|HP降到一半或以下時", "text|l|水系招式|Water", "frame|self|傷害|plus|d1"],
		"effect": "當這隻寶可夢的HP剩一半或以下，牠水屬性招式的傷害骰池並不會因为疼痛懲罰而被扣除成功骰，且牠水屬性招式的傷害骰池會額外增加 1 顆骰子。",
	...
	},
	{
		...
		"desc": "這隻寶可夢的利爪是如此堅實，牠能夠把幾乎所有一切都撕成两半。"
	},
	{
	...
	},
	{
		...
		"effect": "這隻寶可夢會在出場時複製一个随机敵人的特性。這个效果會在這隻寶可夢脫離戰鬥時終止。下列特性無法被複製：花之禮、幻覺、變身者、戰鬥切換、神奇守護、以及其他與形態變化有關的特性。",
	...
	},
	{
		...
		"tags": ["target|l|self"],
		"effect": "每過两个回合，骰這隻寶可夢的忠誠度进行掷骰判定，並取得至少 2 顆成功骰。若判定失敗，則這隻寶可夢將會拒絕行動。若判定成功，則牠將如常行動。",
	...
	},
	{
		...
		"tags": ["target|l|self"],
		"effect": "如果有任何招式、物品、或特性會阻止這隻寶可夢以某个敵人为目標、或造成任何效果，將其忽略。（例如：「免疫」特性的寶可夢仍然會陷入「中毒」狀態、「飄浮」特性仍會被地面屬性招式給命中。）",
		"desc": "這隻寶可夢創造出一个旋转不停的巨大火球包圍著一切，阻止牠的敵人離開牠的觸及範圍。沒有任何人能夠從高熱中逃脫。"
	},
	{
	...
	},
	{
		...
		"desc": "在從隨身攜帶的東西中解放的瞬間就是這隻寶可夢感到最为舒適的時候。牠樂於不受拘束地四處亂跑。"
	},
	{
		"name": "緊張感", "alias": "きんちょうかん|Unnerve",
		"tags": ["target|l|foe", "nftext|l|無法食用樹果"],
		"effect": "當這隻寶可夢在場上時，對手將無法吃掉牠持有的樹果。",
		"desc": "也許是因为牠迫力十足的瞪視、又或許是因为牠凶狠的存在，這隻寶可夢附近的其他人將變得相當緊張，甚至到失去食慾的程度。"
	},
	{
		"name": "勝利之星", "alias": "しょうりのほし|Victory Star",
		"tags": ["target|l|allally", "effect|l|neverfail"],
		"effect": "在這隻寶可夢處於戰場期間，這隻寶可夢和牠的所有隊友的傷害類招式全都獲得「必中」標誌。這个特性無法被交換或改變。",
	...
	},
	{
		...
		"desc": "實際上這隻寶可夢的身體就是个電池，永遠樂於把電充滿。"
	},
	{
		...
		"desc": "這隻寶可夢是个臉上總掛著哀傷表情的遊魂。牠不會聽從你的呼喚，且可能會在漫無目的的飄浮中迷失方向。最好找个靈媒來治療牠。"
	},
	{
		...
		"desc": "這隻寶可夢的身體大部分都是由水構成，牠能夠將水儲存在體內，並利用它作为營養。"
	},
	{
		...
		"desc": "這隻寶可夢被泡泡給保護著。奇怪的是，這个泡泡裡頭並不是空氣，而是純淨的水。"
	},
	{
	...
	},
	{
		...
		"effect": "每當這隻寶可夢的HP降到最大值的一半或以下時，牠就會回到自己的精靈球內，並派出另一个隊友來代替牠。如果牠沒有任何其他隊友，則戰鬥可能會因此結束。這个特性的效果不會被「阻擋」給影響。",
	...
	},
	{
		...
		"tags": ["target|l|self", "text|l|型態變化"],
		"effect": "只有達摩狒狒能夠使用這个特性。當牠的HP剩一半或以下，牠將會在該戰鬥輪結束時變化成「達摩形態」，在這之後，使用牠達摩形態的数據，並根據階級和特質上限調整牠各个形態的特質。",
