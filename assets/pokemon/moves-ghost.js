...
Array.prototype.push.apply(MoveList, [
	...
	},
	{
		...
		"accuracy": "意志 + 導引",
		"damage": "-",
		"effect": "骰等同於使用者HP一半的傷害骰以對自己造成傷害，無視防禦。直到這个詛咒解除，目標的所有掷骰中都將被扣除 1 顆成功骰。",
		"desc": "使用者念誦邪惡的咒語，這个詛咒只能透過靈媒或神性存在的干預來解除。"
	},
	{
		...
		"accuracy": "意志 + 導引",
		"damage": "-",
		"effect": "提升使用者的力量和防禦，降低使用者的靈巧。這个效果只會作用於非幽靈屬性的寶可夢身上。",
	...
	},
	{
		...
		"accuracy": "意志 + 導引",
		"damage": "-",
		"effect": "如果使用者在這个戰鬥輪期間因为戰鬥傷害而陷入瀕死狀態，則對牠造成傷害的寶可夢也將在同時陷入瀕死狀態。",
	...
	},
	{
		...
		"accuracy": "意志 + 導引",
		"damage": "-",
		"effect": "使用者陷入瀕死狀態。敵人將失去所有的意志點，並失去任何因为消耗意志點而獲得的效果。敵人若想要繼續戰鬥，則必須在每輪結束時使用牠們的忠誠度來掷骰判定。每一輪所需的成功骰数將再增加 1 顆。",
	...
	},
	{
		...
		"accuracy": "靈巧 + 導引",
		"damage": "特殊 + 2*",
		"effect": "如果目標正處於任何異常狀態中，則這个招式的傷害骰池將額外增加 2 顆骰子。",
	...
	},
	{
		...
		"desc": "使用者舔了舔敵人。牠的唾液能使大多数生物的身體麻木。"
	},
	{
		...
		"accuracy": "特殊 + 導引",
		"damage": "特殊 + 4",
		"effect": "致命傷害。如果敵方有任何能夠避免這个招式造成傷害的效果（例如寶可夢屬性、特性、護盾招式、天氣狀態、或屏障等），無視該效果。這个招式不能被對抗。",
	...
	},
	{
		...
		"accuracy": "意志 + 導引",
		"damage": "-",
		"effect": "只有當目標處於「睡眠」狀態時才能夠發揮效果。對敵人直接造成 1 點傷害。如果目標仍然處於「睡眠」狀態，則接下來每个戰鬥輪開始時都會再次對目標直接造成 1 點傷害。",
	...
	},
	{
		...
		"accuracy": "力量 + 鬥毆",
		"damage": "力量 + 3",
		"effect": "蓄力招式。當這个招式在蓄力時，使用者將不會受到任何其他招式的影響。如果目標使用了護盾招式，則該護盾將被摧毀且不會發揮任何效果。",
		"desc": "寶可夢消失並潛入一个黑暗的異次元，以穿透哪怕是最堅不可摧的防禦。牠可能會在牠的下个行動中再次現身。"
	},
	{
		...
		"desc": "寶可夢投射出一个由陰影和暗物質組成的球體來攻擊敵人。"
	},
	{
		...
		"desc": "這隻寶可夢當作武器的骨頭上寄宿著一个靈魂，這个靈魂可能會附在受害者身上，为其主人創造攻擊的機會。"
	},
	{
		...
		"damage": "力量 + 3",
		"effect": "容易擊中要害。",
		"desc": "爪子變为半虛體化，並能夠短暫地穿透盔甲、獸皮、皮膚和物體，讓這一擊可以攻擊目標身上的任何弱點。"
	},
	{
		...
		"accuracy": "力量 + 鬥毆",
		"damage": "力量 + 5",
		"effect": "致命傷害。蓄力招式。當這个招式在蓄力時，使用者將不會受到任何其他招式的影響。如果目標使用了護盾招式，則該護盾將被摧毀且不會發揮任何效果。這个招式造成的傷害在 24 小時內都無法被治癒。",
		"desc": "寶可夢消失並潛入一个黑暗的異次元並尋找機會攻擊牠的敵人。這一擊傷害的不是目標的身體，而是靈魂。"
	},
	{
	...
	},
	{
		...
		"accuracy": "意志 + 誘惑",
		"damage": "-",
		"effect": "使目標的屬性追加幽靈屬性（例如：喵喵的屬性將變为「一般/幽靈」；噴火龍的屬性將變为「火/飛行/幽靈」）。如果該寶可夢已經擁有第三个屬性，則將該屬性取代为幽靈屬性。",
