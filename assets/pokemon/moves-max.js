...
Array.prototype.push.apply(MoveList, [
	{
		"name": "极巨蟲蠱", "alias": "ダイワーム|Max Flutterby",
		"power": "+2",
		"category": "hybrid",
		"type": "Bug",
	...
	{
		"name": "极巨恶霸", "alias": "ダイアーク|Max Darkness",
		"power": "+2",
		"category": "hybrid",
		"type": "Dark",
		"tags": ["target|l|foe", "frame|target|特防|down|1"],
		"gmax-tags": ["target|l|allfoe", "frame|sleep||number|d3", "frame|flinch||number|d3", "pdice|l|2", "effect|l|lethal", "text|l|恶系招式|Dark"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "降低目标的特防。",
	...
	{
		"name": "极巨龍騎", "alias": "ダイドラグーン|Max Wyrmwind",
		"power": "+2",
		"category": "hybrid",
		"type": "Dragon",
		"tags": ["target|l|foe", "frame|target|力量|down|1"],
		"gmax-tags": ["target|l|allfoe", "effect|l|lethal", "frame|flinch||number|d3", "frame|self|特质|up|1", "frame|target|意志点|down|1", "text|l|龍系招式|Dragon"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "降低目标的力量。",
	...
	{
		"name": "极巨闪電", "alias": "ダイサンダー|Max Lightning",
		"power": "+2",
		"category": "hybrid",
		"type": "Electric",
		"tags": ["target|l|foe", "text|l|電氣場地|Electric"],
		"gmax-tags": ["target|l|allfoe", "frame|paralysis||always", "frame||異常状態|always", "effect|l|block", "frame|self|傷害|plus|d1", "text|l|電系招式|Electric"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "发动電氣場地的效果。持續 4 个戰鬥輪。",
	...
	{
		"name": "极巨妖精", "alias": "ダイフェアリー|Max Starfall",
		"power": "+2",
		"category": "hybrid",
		"type": "Fairy",
	...
	{
		"name": "极巨拳鬥", "alias": "ダイナックル|Max Knuckle",
		"power": "+2",
		"category": "hybrid",
		"type": "Fight",
		"tags": ["target|l|foe", "target|l|allally", "frame|self|力量|up|1"],
		"gmax-tags": ["target|l|allfoe", "effect|l|crit", "frame|self|傷害|plus|d2", "frame|self|特质|down|never", "frame|flinch||number|d3", "text|l|格鬥招式|Fight"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
	...
	{
		"name": "极巨火爆", "alias": "ダイバーン|Max Flare",
		"power": "+2",
		"category": "hybrid",
		"type": "Fire",
		"tags": ["target|l|foe", "weather|l|sun"],
		"gmax-tags": ["target|l|allfoe", "weather|l|sun2", "text|l|无視特性", "frame|burn3||number|d3", "effect|l|block", "text|l|火系招式|Fire"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "发动大晴天天氣状態的效果。持續 4 个戰鬥輪。",
	...
	{
		"name": "极巨飛衝", "alias": "ダイジェット|Max Airstream",
		"power": "+2",
		"category": "hybrid",
		"type": "Flying",
		"tags": ["target|l|foe",  "target|l|allally", "frame|self|灵巧|up|1"],
		"gmax-tags": ["target|l|allfoe", "weather|l|wind", "effect|l|crit", "frame|self|特质|down|never", "frame|heal|治療状態|always", "text|l|飛行招式|Flying"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "提升使用者和範圍內所有隊友的灵巧。",
	...
	{
		"name": "极巨幽魂", "alias": "ダイホロウ|Max Phantasm",
		"power": "+2",
		"category": "hybrid",
		"type": "Ghost",
		"tags": ["target|l|foe", "frame|target|防禦|down|1"],
		"gmax-tags": ["target|l|allfoe", "effect|l|lethal", "frame|flinch||number|d3", "effect|l|block", "frame|target|意志点|down|1", "text|l|幽灵招式|Ghost"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "降低目标的防禦。",
	...
	{
		"name": "极巨草原", "alias": "ダイソウゲン|Max Overgrowth",
		"power": "+2",
		"category": "hybrid",
		"type": "Grass",
		"tags": ["target|l|foe", "text|l|青草場地|Grass"],
		"gmax-tags": ["target|l|allfoe", "frame|target|灵巧|down|1", "text|l|无視特性", "frame|heal|治療状態|always", "frame|target|闪避|down|1", "text|l|草系招式|Grass"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "发动青草場地的效果。持續 4 个戰鬥輪。",
	...
	{
		"name": "极巨大地", "alias": "ダイアース|Max Quake",
		"power": "+2",
		"category": "hybrid",
		"type": "Ground",
		"tags": ["target|l|foe", "target|l|allally", "frame|self|特防|up|1"],
		"gmax-tags": ["target|l|allfoe", "frame|self|傷害|plus|d2", "effect|l|block", "effect|l|crit", "text|l|无視特性", "text|l|地面招式|Ground"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
	...
	{
		"name": "极巨寒冰", "alias": "ダイアイス|Max Hailstorm",
		"power": "+2",
		"category": "hybrid",
		"type": "Ice",
	...
	{
		"name": "极巨攻擊", "alias": "ダイアタック|Max Strike",
		"power": "+2",
		"category": "hybrid",
		"type": "Normal",
		"tags": ["target|l|foe", "frame|target|灵巧|down|1"],
		"gmax-tags": ["target|l|allfoe", "effect|l|lethal", "frame|paralysis||number|d3", "frame|self|特质|up|1", "frame|self|傷害|plus|d2", "text|l|一般招式|Normal"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "降低目标的灵巧。",
	...
	{
		"name": "极巨酸毒", "alias": "ダイアシッド|Max Ooze",
		"power": "+2",
		"category": "hybrid",
		"type": "Poison",
		"tags": ["target|l|foe", "target|l|allally", "frame|self|特殊|up|1"],
		"gmax-tags": ["target|l|allfoe", "frame|poison2||number|d3", "frame|burn1||number|d3", "frame|target|特质|down|1", "effect|l|lethal", "text|l|毒系招式|Poison"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
	...
	{
		"name": "极巨超能", "alias": "イサイコ|Max Mindstorm",
		"power": "+2",
		"category": "hybrid",
		"type": "Psychic",
		"tags": ["target|l|foe", "text|l|精神場地|Psychic"],
		"gmax-tags": ["target|l|allfoe", "text|l|无視特性", "frame|sleep||number|d3", "frame|confuse||always", "effect|l|neverfail", "text|l|超能招式|Psychic"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "发动精神場地的效果。持續 4 个戰鬥輪。",
	...
	{
		"name": "极巨岩石", "alias": "ダイロック|Max Rockfall",
		"power": "+2",
		"category": "hybrid",
		"type": "Rock",
		"tags": ["target|l|foe", "weather|l|sand"],
		"gmax-tags": ["target|l|allfoe", "effect|l|lethal", "frame|flinch||number|d3", "frame|self|傷害|plus|d2", "frame|target|特质|down|1", "text|l|岩石招式|Rock"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "发动沙暴天氣状態的效果。持續 4 个戰鬥輪。",
	...
	{
		"name": "极巨鋼鐵", "alias": "ダイスチル|Max Steelspike",
		"power": "+2",
		"category": "hybrid",
		"type": "Steel",
		"tags": ["target|l|foe", "target|l|allally", "frame|self|防禦|up|1"],
		"gmax-tags": ["target|l|allfoe", "frame|self|特质|down|never", "frame|flinch||number|d3", "frame|self|受到傷害|minus|2", "frame|self|傷害|plus|d2", "text|l|鋼系招式|Steel"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
	...
	{
		"name": "极巨水流", "alias": "ダイストリーム|Max Geyser",
		"power": "+2",
		"category": "hybrid",
		"type": "Water",
		"tags": ["target|l|foe", "weather|l|rain"],
		"gmax-tags": ["target|l|allfoe", "weather|l|rain2", "text|l|无視特性", "frame|target|特质|down|1", "frame|burn1||number|d3", "text|l|水系招式|Water"],
		"accuracy": "原招式命中 + 2",
		"damage": "力量/特殊 + 原招式傷害 + 2",
		"effect": "发动下雨天氣状態的效果。持續 4 个戰鬥輪。",
