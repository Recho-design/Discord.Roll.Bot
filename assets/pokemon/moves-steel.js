...
Array.prototype.push.apply(MoveList, [
	{
		...
		"damage": "力量 + 3",
		"effect": "遠程攻擊。阻擋。",
		"desc": "寶可夢朝著牠的敵人投出船錨，並用海草纏住對手，這个船錨將拖住敵人使其無法逃脫。"
	},
	{
		...
		"desc": "寶可夢甩落多餘部件，並開始旋转身體其他部位以进行更輕便的活動。"
	},
	{
	...
	},
	{
		...
		"accuracy": "洞察 + 誘惑",
		"damage": "特殊 + 6",
		"effect": "這个招式將在下下个戰鬥輪結束時造成傷害。它將無視任何護盾招式或掩護的效果。如果目標無法戰鬥或被換下場，則傷害目標將會變为下一个對手或牠的其中一个同伴。在說書人的裁斷下，這个招式可能會造成額外的效果。",
	...
	},
	{
		...
		"desc": "使用者硬化自己的雙臂，接著以高速旋转它們以連續攻擊敵人二次。這陣打擊能夠讓其受害者被輾倒在地。"
	},
	{
	...
	},
	{
		...
		"accuracy": "活力 + 導引",
		"damage": "-",
		"effect": "提升一个鋼屬性或電屬性隊友的力量和特殊。",
		"desc": "使用者將牠的齒輪接上一名隊友，讓隊友的身體如同運转順暢的機器一樣運作。"
	},
	{
		...
		"accuracy": "靈巧 + 鬥毆",
		"damage": "力量 + 1*",
		"effect": "使用者的靈巧每低於目標一點，這个招式的傷害骰池就可以額外增加 1 顆骰子。你最多可以透過這个方式增加 5 顆骰子。",
		"desc": "使用者蜷縮成球並高速旋转以攻擊目標。"
	},
	{
		...
		"accuracy": "靈巧 + 鬥毆",
		"damage": "力量 + 1*",
		"effect": "使用者的體重每超過目標 50公斤，這个招式的傷害骰池就可以額外增加 1 顆骰子。你最多可以透過這个方式增加 4 顆骰子。",
	...
	},
	{
		...
		"desc": "使用者揮動牠硬化的尾巴攻擊敵人。目標將因为這一系列攻擊而變得脆弱。"
	},
	{
	...
	},
	{
		...
		"damage": "力量 + 2",
		"effect": "遠程攻擊。必中。",
		"desc": "寶可夢投掷出能夠如同磁鐵一般將目標吸引過來的金屬炸彈。在炸彈接觸到目標的瞬間，它就會爆炸。"
	},
	{
		...
		"accuracy": "靈巧 + 鬥毆",
		"damage": "不定",
		"effect": "這个招式只能在敵人剛剛进行了攻擊後才能夠發揮作用。這个招式的傷害骰池等同於你敵人上次攻擊的傷害骰池再額外增加 2 顆骰子。無視敵人的防禦。",
		"desc": "在承受傷害之後，因为敵人攻擊而脫落，使用者爆發出無数細小而尖銳的金屬碎片。牠承受的衝擊越大，射出的金屬碎片就越多。"
	},
	{
	...
	},
	{
		...
		"desc": "使用者射出一道光束使敵人頭暈目眩。那些體驗過這一擊的受害者會把這个經歷形容为「被困在鏡子迷宮之中」。"
	},
	{
		...
		"damage": "-",
		"effect": "提升使用者的力量和靈巧。",
		"desc": "寶可夢讓牠的齒輪高速旋转，如同高功率的機器一樣運转。"
	},
	{
		...
		"damage": "力量 + 3",
		"effect": "致命傷害。必中。",
		"desc": "使用者運用其中一个牠銳利的尖角以驚人的準確度刺向敵人，這一擊留下的傷口相當深刻，且必須被立即治療。"
	},
	{
	...
	},
	{
		...
		"accuracy": "力量 + 鬥毆",
		"damage": "力量 + 4",
		"effect": "如果敵方有任何事物將阻止這个招式造成傷害（例如寶可夢屬性、特性、護盾招式、天氣、或屏障），將其忽略。這个招式無法被對抗。",
