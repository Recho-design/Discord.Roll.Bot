...
Array.prototype.push.apply(MoveList, [
	{
		...
		"desc": "使用者用骨頭狠狠擊打目標，可能會在目標頭上留下一个腫包。"
	},
	{
	...
	},
	{
		...
		"damage": "力量 + 2",
		"effect": "遠程攻擊。雙重行動。",
		"desc": "寶可夢扔出一根骨頭擊打敵人。骨頭像會像回力鏢一樣，攻擊两次。"
	},
	{
	...
	},
	{
		...
		"accuracy": "靈巧 + 鬥毆",
		"damage": "力量 + 3",
		"effect": "蓄力招式。當這个招式在蓄力時，使用者將脫離招式的影響範圍。但是〈地震〉、〈震級〉和其他類似招式仍然可以命中使用者。",
	...
	},
	{
		...
		"damage": "力量 + 3",
		"effect": "容易擊中要害。",
		"desc": "使用者旋转身體，如同鑽頭一樣撞向敵人。這種攻擊可以輕鬆而精確地穿透牆壁和地板。"
	},
	{
	...
	},
	{
		...
		"accuracy": "特殊 + 自然",
		"damage": "-",
		"effect": "在接下來 4 个戰鬥輪期間，電屬性攻擊的傷害骰池將無法獲得其招式威力的加值。",
	...
	},
	{
		...
		"desc": "寶可夢四處挖掘，翻耕土壤，使其成为植物生長的理想場所。"
	},
	{
	...
	},
	{
		...
		"accuracy": "靈巧 + 導引",
		"damage": "力量 + 2",
		"effect": "遠程攻擊。阻擋。每个戰鬥輪結束時，骰 2 顆傷害骰以對敵人造成傷害。持續 4 輪。",
		"desc": "寶可夢在敵人周圍製造一个流沙坑，使牠無法逃脫。"
	},
	{
		...
		"accuracy": "洞察 + 自然",
		"damage": "-",
		"effect": "基礎治癒。如果當前天氣狀態为沙暴，則這个招式變为 強效治癒。",
	...
	},
	{
		...
		"accuracy": "特殊 + 自然",
		"damage": "-",
		"effect": "入場危害。敵方寶可夢在換上場時會失去 1 點HP，這个效果不會疊加。飛行屬性或飄浮特性的寶可夢免疫這个效果。",
	...
	},
	{
		...
		"accuracy": "靈巧 + 鬥毆",
		"damage": "力量 + 3*",
		"effect": "如果使用者上次施展的招式的命中判定失敗，則這个招式的傷害骰池將額外增加 2 顆骰子。",
	...
	},
	{
		...
		"accuracy": "力量 + 導引",
		"damage": "力量 + 3",
		"effect": "致命傷害。遠程攻擊。若成功，在這个場景期間，飛行屬性或飄浮特性的寶可夢將能夠被地面屬性的招式命中。",
		"desc": "不知從何處射出的密密麻麻的尖銳碎片，從空中朝著敵人們如雨般落下，就算是在空中的生物們在被擊中後也會摔落到地面上。找个掩護吧，這還挺疼的。"
	},
	{
