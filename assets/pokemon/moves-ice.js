...
Array.prototype.push.apply(MoveList, [
	{
		...
		"desc": "寶可夢射出美麗的虹彩光束，可能會讓敵人为其大吃一驚。"
	},
	{
		...
		"accuracy": "特殊 + 導引",
		"damage": "-",
		"effect": "如果當前天氣狀態不为冰雹，則這个招式將自動失敗。物理和特殊招式對使用者和所有隊友造成的傷害將減少 1 點，持續 4 輪，即使冰雹天氣提前結束也一樣。",
		"desc": "極光和冰雹以寶可夢和牠的隊友們为中心迴旋，將攻擊偏折開來。"
	},
	{
		...
		"accuracy": "靈巧 + 鬥毆",
		"damage": "力量 + 2*",
		"effect": "後制招式。如果目標在這个戰鬥輪中已經對使用者造成過的傷害，則這个招式的傷害骰池額外增加 2 顆骰子。",
	...
	},
	{
		...
		"accuracy": "特殊 + 導引",
		"damage": "特殊 + 5",
		"effect": "以所有範圍內的敵人为目標。骰 1 顆機率骰以使目標陷入「冰凍」狀態。如果當前天氣狀態为大晴天，則這个招式的命中率降低效果將改为 -3；如果當前天氣狀態为冰雹，則無視這个招式的命中率降低效果，且這个招式將無法被閃避。",
	...
	},
	{
		...
		"desc": "使用者彷彿變成了一大塊冰塊，接著牠伴隨著毀滅性的電流爆發將自己從冰塊中釋放出來。爆發四散的冰塊碎片和強烈閃電遍佈了整个戰場。"
	},
	{
		...
		"accuracy": "特殊 + 導引",
		"damage": "特殊 + 3",
		"effect": "若成功，解除敵人身上所有特質和能力的增益或減益。如果這个招式的使用者處於最終進化階段，則這个招式自動失敗。",
	...
	},
	{
		...
		"accuracy": "靈巧 + 導引",
		"damage": "特殊 + 2",
		"effect": "這个招式永遠會擊中要害，並獲得相應的獎勵傷害骰。",
	...
	},
	{
		...
		"accuracy": "靈巧 + 導引",
		"damage": "特殊 + 2",
		"effect": "致命傷害。以所有範圍內的敵人为目標。降低目標的靈巧。",
		"desc": "空氣冰冷到就連稍微動彈、看清周圍、以及呼吸都會受傷。你的當務之急應該是趕快逃跑，因为待在這裡的每分每秒都會讓你的生命慢慢枯竭。"
	},
	{
	...
	},
	{
		...
		"desc": "使用者蜷縮成一个雪球，滾動撞向敵人。雪球會隨著滾動變得越來越大。"
	},
	{
	...
	},
	{
		...
		"desc": "使用者彷彿變成了一大塊冰塊，接著牠伴隨著毀滅性的爆炸將自己從冰塊中釋放出來。爆發四散的冰塊碎片和烈火遍佈了整个戰場。"
	},
	{
	...
	},
	{
		...
		"accuracy": "特殊 + 自然",
		"damage": "-",
		"effect": "在接下來 4 个戰鬥輪期間，使用者和隊友的特質和能力都不會被降低。",
	...
	},
	{
		...
		"accuracy": "靈巧 + 導引",
		"damage": "特殊 + 2",
		"effect": "以所有範圍內的敵人为目標。骰 1 顆機率骰以使敵人陷入「冰凍」狀態。",
	...
	},
	{
		...
		"desc": "使用者從內而外凍結敵人，這个攻擊的受害者將會需要接受緊急的醫療救護。"
	}
]);