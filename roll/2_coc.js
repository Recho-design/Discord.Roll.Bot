...
const cocPhobias = [
	...
	['6) 喜曠症（Agromania）：强烈地傾向於待在開闊空間中。'],
	['7) 喜尖狂（Aichmomania）：痴迷於尖銳或鋒利的物體。'],
	...
	['29) 色彩狂（Coloromania）：痴迷於某種顔色。'],
	['30) 小丑狂（Coulromania）：痴迷於小丑。'],
	['31) 恐懼狂（Countermania）：執著於經歷恐怖的場面。'],
	['32) 殺戮癖（Dacnomania）：痴迷於殺戮。'],
	['33) 魔臆症（Demonomania）：病態地堅信自己已被惡魔附身。'],
	['34) 抓撓癖（Dermatillomania）：執著於抓撓自己的皮膚。'],
	['35) 正義狂（Dikemania）：痴迷於目睹正義被伸張。'],
	...
	['42) 職業狂（Empleomania）：對於工作的無盡病態渴求。'],
	...
	['62) 噪音癖（Ligyromania）：無法自製地執著於製造響亮或刺耳的噪音。'],
	['63) 喜綫癖（Linonomania）：痴迷於綫繩。'],
	['64) 彩票狂（Lotterymania）：極端地執著於購買彩票。'],
...
const cocManias = [
	['1) 洗澡恐懼症（Ablutophobia）：對於洗滌或洗澡的恐懼。'],
	['2) 恐高症（Acrophobia）：對於身處高處的恐懼。'],
	['3) 飛行恐懼症（Aerophobia）：對飛行的恐懼。'],
	['4) 廣場恐懼症（Agoraphobia）：對於開放的（擁擠）公共場所的恐懼。'],
	['5) 恐鶏症（Alektorophobia）：對鶏的恐懼。'],
	['6) 大蒜恐懼症（Alliumphobia）：對大蒜的恐懼。'],
	['7) 乘車恐懼症（Amaxophobia）：對於乘坐地面載具的恐懼。'],
	['8) 恐風症（Ancraophobia）：對風的恐懼。'],
	['9) 男性恐懼症（Androphobia）：對於成年男性的恐懼。'],
	...
	['31) 丟弃恐懼症（Disposophobia）：對於丟弃物件的恐懼（貯藏癖）。'],
	['32) 皮毛恐懼症（Doraphobia）：對動物皮毛的恐懼。'],
	['33) 過馬路恐懼症（Dromophobia）：對於過馬路的恐懼。'],
	...
	['49) 催眠恐懼症①（Hypnophobia）：對於睡眠或被催眠的恐懼。'],
	...
	['58) 巨物恐懼症（Megalophobia）：對於龐大物件的恐懼。'],
	['59) 捆綁恐懼症（Merinthophobia）：對於被捆綁或緊縛的恐懼。'],
	['60) 流星恐懼症（Meteorophobia）：對流星或隕石的恐懼。'],
	['61) 孤獨恐懼症（Monophobia）：對於一人獨處的恐懼。'],
	...
	['73) 吞咽恐懼症（Phagophobia）：對於吞咽或被吞咽的恐懼。'],
